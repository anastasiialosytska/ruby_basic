...
class Menu
  ...
  def delete_station
    ...
    elsif puts 'Несуществующий маршрут или станция'
    end
  end
  ...
  def follow_route
    ...
    elsif puts 'Несуществующий маршрут или поезд'
    end
  end
  ...
  def add_carriage
    ...
    if @train.instance_of?(PassengerTrain) && @trains.keys.include?(@train_number)
    ...
    elsif @train.instance_of?(CargoTrain) && @trains.keys.include?(@train_number)
